...
public class MatchInput {
    ...
    public String getNeutral_venvue() {
        return neutral_venvue;
    }
    public void setNeutral_venvue(String neutral_venvue) {
        this.neutral_venvue = neutral_venvue;
    }
